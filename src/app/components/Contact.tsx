...
export default function Contact() {
  return (
    <div id='Contact' className='mt-10'>
        ...
        <div className='flex flex-wrap justify-center mt-5 pb-5 sm:p-10 gap-20'>
        <div className='flex items-center flex-col gap-20'>
        <a target='_blank' href="https://twitter.com/iam_dev_armaan">
        ...
        <div className='flex items-center flex-col gap-20'>
        <a target='_blank' href="https://www.linkedin.com/in/armaan-zeyad-050361279/">
          <svg className='h-[3rem] lg:h-[4rem]' viewBox="0 0 128 128" >
        ...
        <div className='flex items-center flex-col gap-20'>
        <a target='_blank' href="https://github.com/user-1289">
          <svg className='h-[3rem] lg:h-[4rem]' viewBox="0 0 128 128" >
